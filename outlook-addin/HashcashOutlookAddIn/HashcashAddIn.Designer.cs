...
namespace HashcashOutlookAddIn {
    ...
    public sealed partial class HashcashAddIn : Microsoft.Office.Tools.Outlook.OutlookAddInBase {
        ...
        public HashcashAddIn(global::Microsoft.Office.Tools.Outlook.Factory factory, global::System.IServiceProvider serviceProvider) : 
                base(factory, serviceProvider, "AddIn", "HashcashAddIn") {
    ...
    internal sealed partial class Globals {
        ...
        private static HashcashAddIn _hashcashAddIn;
        ...
        internal static HashcashAddIn HashcashAddIn {
            get {
                return _hashcashAddIn;
            }
            set {
                if ((_hashcashAddIn == null)) {
                    _hashcashAddIn = value;
                }
                else {
        ...
        internal static ThisFormRegionCollection FormRegions {
            get {
                if ((_ThisFormRegionCollection == null)) {
                    _ThisFormRegionCollection = new ThisFormRegionCollection(Globals.HashcashAddIn.GetFormRegions());
                }
    ...
    internal sealed partial class ThisFormRegionCollection : Microsoft.Office.Tools.Outlook.FormRegionCollectionBase {
        ...
        internal WindowFormRegionCollection this[Microsoft.Office.Interop.Outlook.Explorer explorer] {
            get {
                return ((WindowFormRegionCollection)(Globals.HashcashAddIn.GetFormRegions(explorer, typeof(WindowFormRegionCollection))));
            }
        }
        
        internal WindowFormRegionCollection this[Microsoft.Office.Interop.Outlook.Inspector inspector] {
            get {
                return ((WindowFormRegionCollection)(Globals.HashcashAddIn.GetFormRegions(inspector, typeof(WindowFormRegionCollection))));
            }
        }
    }
